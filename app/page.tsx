...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <PublicHeader />
      <main className="flex-1 bg-gradient-hero bg-noise">
        {/* Hero Section */}
        <section className="relative min-h-[calc(100dvh-4rem)] flex items-center overflow-hidden">
          <div className="container-wide relative z-10 grid gap-12 lg:grid-cols-2 lg:gap-16 items-center py-20 md:py-32">
            ...
            <div className="space-y-8 text-center lg:text-left">
              ...
              {/* Subheadline */}
              <p className="animate-fade-in-up stagger-3 text-lg text-muted-foreground max-w-2xl mx-auto lg:mx-0">
                Covalisage international rapide, sécurisé et économique
              </p>
              ...
              {/* CTA Buttons - sobres, pas de surcharge */}
              <div className="animate-fade-in-up stagger-4 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-4">
                <Button asChild>
                  <Link href="/register">
            ...
            {/* Right: Hero Illustration - minimal et sobre */}
            <div className="relative order-first lg:order-last">
              <div className="relative w-full max-w-md mx-auto">
                {/* Main illustration - simple et direct */}
