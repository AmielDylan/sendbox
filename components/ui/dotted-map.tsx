...
/** addMarkers renvoie les marqueurs sans lat/lng ; seuls x, y et les autres props (ex. size) restent */
...
export function DottedMap<M extends Marker = Marker>({
  ...
  // Calcule le décalage de stagger en un seul passage simple
  // (pas de useMemo : `points` provient d'une lib tierce non garantie stable en référence)
