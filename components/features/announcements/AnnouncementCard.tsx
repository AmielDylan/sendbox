          ...
          <CardContent className="p-4 sm:p-5 flex-1">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full">
                <Badge variant="secondary" className="flex-1 justify-start items-start flex-col bg-muted/50 text-foreground border-0 font-sans px-3 py-2 h-auto whitespace-nowrap">
                ...
                <div className="flex gap-2 flex-1 sm:flex-none">
                  <Badge variant="secondary" className="flex-1 sm:flex-none justify-start items-start flex-col bg-primary/5 text-primary border-0 font-sans px-3 py-2 h-auto whitespace-nowrap min-w-[100px]">
