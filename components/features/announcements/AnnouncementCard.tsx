              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full">
                ...
                >
                  ...
                  <div className="flex items-center font-bold text-sm">
                    <IconCalendar
                      ...
                      stroke={1.5}
                    />
                    {format(new Date(announcement.departure_date), 'd MMMM', {
                      locale: fr,
                    })}
                    <IconArrowNarrowRight
                      className="h-3.5 w-3.5 mx-1.5 text-muted-foreground/70"
                      stroke={1}
                    />
                    {announcement.arrival_date
                      ? format(new Date(announcement.arrival_date), 'd MMMM', {
                          locale: fr,
                        })
                      : '?'}
                  </div>
                ...
                <div className="flex gap-2 flex-1 sm:flex-none">
                  ...
                  {showMatchScore && announcement.match_score > 0 && (
                    <Badge
                      variant="outline"
                      className="flex-1 sm:flex-none justify-start items-start flex-col text-emerald-600 border-emerald-500/20 bg-emerald-500/5 font-sans px-3 py-2 h-auto whitespace-nowrap"
                    >
                      <span className="text-[10px] text-emerald-600/70 font-medium uppercase tracking-wider mb-1">
                        Match
                      </span>
