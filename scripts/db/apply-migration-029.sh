#!/bin/bash
# Script pour appliquer la migration 029 sur Supabase

echo "🚀 Application de la migration 029: Add missing RLS policies for bookings"
echo ""

# Lire le fichier de migration
MIGRATION_FILE="supabase/migrations/029_add_bookings_rls_policies.sql"
...
echo "   - Les politiques RLS devraient être créées"
