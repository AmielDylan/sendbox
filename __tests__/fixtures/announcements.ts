import { createMockAnnouncement, type MockAnnouncement } from '../factories/announcement.factory'
...
export const MOCK_ANNOUNCEMENT_PARIS_COTONOU: MockAnnouncement = createMockAnnouncement({
  id: 'announcement-paris-cotonou-1',
  traveler_id: MOCK_TRAVELER.id,
  title: 'Paris → Cotonou',
  description: 'Vol direct Paris-Cotonou, disponible pour transporter vos colis en toute sécurité.',
...
export const MOCK_ANNOUNCEMENT_PARIS_PORTO_NOVO: MockAnnouncement = createMockAnnouncement({
...
// Annonce archivée
export const MOCK_ANNOUNCEMENT_ARCHIVED: MockAnnouncement = createMockAnnouncement({
...
export const MOCK_ANNOUNCEMENT_HIGH_PRICE: MockAnnouncement = createMockAnnouncement({
...
export const MOCK_ANNOUNCEMENT_HIGH_WEIGHT: MockAnnouncement = createMockAnnouncement({
