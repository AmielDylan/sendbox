-- Migration: Fix column names in search functions
-- Created: 2026-01-19
-- Description: Use correct column names (firstname/lastname) and fix EXTRACT type casting

-- Drop and recreate search_announcements with correct column names
...
-- Drop and recreate count_search_announcements with correct date casting
...
-- Add comments
COMMENT ON FUNCTION search_announcements IS 'Public search for announcements. No authentication required. Uses firstname/lastname from profiles table.';
COMMENT ON FUNCTION count_search_announcements IS 'Count announcements matching search filters. No authentication required.';
