-- Migration: Grant execute permissions on search functions
-- Created: 2026-01-19
-- Description: Add SECURITY DEFINER and grant execute permissions to allow public access

-- Drop and recreate search_announcements with SECURITY DEFINER
...
-- Drop and recreate count_search_announcements with SECURITY DEFINER
...
COMMENT ON FUNCTION search_announcements IS 'Search announcements with filters. Returns aliased column names for backwards compatibility. Uses departure_country/arrival_country internally.';
COMMENT ON FUNCTION count_search_announcements IS 'Count announcements matching search filters. Uses departure_country/arrival_country internally.';
