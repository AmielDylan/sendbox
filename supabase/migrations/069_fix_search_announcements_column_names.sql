-- Migration: Fix search_announcements to use correct column names
-- Created: 2026-01-19
-- Description: Update search_announcements to use departure_country/arrival_country instead of origin_country/destination_country

-- Drop the old function first
DROP FUNCTION IF EXISTS search_announcements(TEXT, TEXT, DATE, INTEGER, TEXT, INTEGER, INTEGER);

-- Create the new version with correct column names
